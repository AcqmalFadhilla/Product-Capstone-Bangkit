...
interface TourismPlaceDao {
    ...
    @Transaction
    @Query("SELECT tourism_place.placeId as placeId, tourism_place.placeName as placeName, tourism_category.categoryName as placeCategory, tourism_place.placeRating as  placeRating, tourism_place.isFavorited as isFavoritedPlace , tourism_place.placePhotoUrl as placePhotoUrl from tourism_place LEFT JOIN tourism_category ORDER BY placeId ASC")
