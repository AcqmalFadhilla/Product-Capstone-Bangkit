...
interface TourismPlanDao{
    ...
    @Transaction
    @Query("SELECT tourism_plan.planId as planId, tourism_plan.planTitle as planTitle, tourism_place.placeName as placeName, tourism_category.categoryName as tourismCategory, tourism_plan.planDate as planDate FROM tourism_plan \n" +
